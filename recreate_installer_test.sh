#!/bin/bash
set -Eeuo pipefail
name=ailinux-installer-test
iso=/home/zombie/AILinuX-Distro/output/ailinux-26.04-amd64-20260801T051946Z.iso
disk=/tmp/ailinux-installer-test.qcow2
...
virt-install --connect qemu:///system \
  --name "$name" --memory 4096 --vcpus 2 --cpu host-passthrough --machine q35 \
...
for i in $(seq 1 120); do
  ...
  sleep 2
  if [ "$i" -eq 120 ]; then echo AGENT_TIMEOUT; exit 1; fi
done
