---- MODULE MeshGuardian_TTrace_1767118401 ----
...
_inv ==
    ~(
        ...
        /\
        nodeState = ([hetzner |-> "unhealthy", backup |-> "unhealthy"])
        /\
        guardianActive = (TRUE)
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("MeshGuardian_TTrace_1767118401.json", _TETrace)
...
\*
\*trace == IODeserialize("MeshGuardian_TTrace_1767118401.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([restartCount |-> [hetzner |-> 0, backup |-> 0],nodeState |-> [hetzner |-> "unhealthy", backup |-> "unhealthy"],guardianActive |-> TRUE,failureCount |-> [hetzner |-> 0, backup |-> 0],lastHealthCheck |-> "-"])
    >>
----
...
---- CONFIG MeshGuardian_TTrace_1767118401 ----
CONSTANTS
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue Dec 30 19:13:21 CET 2025