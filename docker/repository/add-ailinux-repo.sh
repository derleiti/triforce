...
deb.nodesource.com/node_22.x|nodistro|main|amd64|nodistro|NodeSource 22.x|${KEYRING_PATH}|
dl.google.com/linux/chrome/deb|stable|main|amd64|stable|Google Chrome|${KEYRING_PATH}|
dl.winehq.org/wine-builds/ubuntu|${codename}|main|amd64,i386|${codename}|WineHQ|${KEYRING_PATH}|
download.docker.com/linux/ubuntu|${codename}|stable|amd64|${codename}|Docker CE|${KEYRING_PATH}|
packages.microsoft.com/repos/code|stable|main|amd64|stable|VS Code|${KEYRING_PATH}|
...
repo.steampowered.com/steam|stable|steam|amd64,i386|stable|Steam|${KEYRING_PATH}|
EOF
}
