...
ERRORS=0
deploy_token "zombie@10.10.0.2"     "zombie-pc" "$ZOMBIE_TOKEN" "/home/zombie/triforce/.env" || ERRORS=$((ERRORS+1))
deploy_token "backupuser@10.10.0.3" "backup"    "$BACKUP_TOKEN" "/home/zombie/triforce/.env" || ERRORS=$((ERRORS+1))
